...
const ERC20TokenCrowdsale = artifacts.require('ERC20TokenCrowdsale');
const RefundVault = artifacts.require('./RefundVault');
const TokenTimelock = artifacts.require('./TokenTimelock');

contract('ERC20TokenCrowdsale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]) {
  ...
  beforeEach(async function () {
    ...
    // Deploy Token
    this.token = await ERC20Token.new(
      this.name,
      this.symbol,
      this.decimals
    );
    ...
    this.crowdsale = await ERC20TokenCrowdsale.new(
      this.rate,
      this.wallet,
      this.token.address,
      this.cap,
